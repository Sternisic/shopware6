...
class __TwigTemplate_d6ac26e8ede6331debf7e59df06b863bfff963509c5dbe6c9b36f9690f3f2ce6 extends Template
{
    private $source;
    private $macros = [];
...
";
        ...
        if ( !array_key_exists("filterRangeActiveMinLabel", $context)) {
            // line 8
            echo "    ";
            $context["filterRangeActiveMinLabel"] = $this->extensions['Shopware\Core\Framework\Adapter\Twig\Extension\SwSanitizeTwigFilter']->sanitize($this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("listing.filterRangeActiveMinLabel"));
        }
        // line 10
        echo "
";
        ...
        if ( !array_key_exists("filterRangeActiveMaxLabel", $context)) {
            // line 12
            echo "    ";
            $context["filterRangeActiveMaxLabel"] = $this->extensions['Shopware\Core\Framework\Adapter\Twig\Extension\SwSanitizeTwigFilter']->sanitize($this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("listing.filterRangeActiveMaxLabel"));
        }
        // line 14
        echo "
";
...
{% endblock %}
", "@Storefront/storefront/component/listing/filter/filter-range.html.twig", "/var/www/html/shopwaresix/vendor/shopware/storefront/Resources/views/storefront/component/listing/filter/filter-range.html.twig");
    }
}
