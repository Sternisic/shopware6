...
class __TwigTemplate_04d8956b7593d44a74b5dfdac6fb0812ac2cd4d7566f354e168be293fdfca90f extends Template
{
    private $source;
    private $macros = [];
...
";
        ...
        <select class=\"sorting custom-select\" aria-label=\"";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["sorting"]) {
                ...
                echo ">";
                echo $this->extensions['Shopware\Core\Framework\Adapter\Twig\Extension\SwSanitizeTwigFilter']->sanitize(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["sorting"], "translated", [], "any", false, false, false, 9), "label", [], "any", false, false, false, 9));
                echo "</option>
            ";
            }
...
{% endif %}
", "@Storefront/storefront/component/sorting.html.twig", "/var/www/html/shopwaresix/vendor/shopware/storefront/Resources/views/storefront/component/sorting.html.twig");
    }
}
