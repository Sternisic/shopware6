...
class __TwigTemplate_d1455ef1f3e67cd15f045bd80618e89b4eb5ac824d6efd34045ce6eec545029d extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_component_product_box_rich_snippets_mpn($context, array $blocks = [])
    {
        ...
        // line 16
        echo "        ";
        if (twig_get_attribute($this->env, $this->source, ($context["product"] ?? null), "manufacturerNumber", [], "any", false, false, false, 16)) {
            // line 17
            echo "            <meta itemprop=\"mpn\"
                  content=\"";
            // line 18
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["product"] ?? null), "manufacturerNumber", [], "any", false, false, false, 18), "html", null, true);
            echo "\"/>
        ";
        }
        // line 20
    ...
    {
        return array (  167 => 20,  162 => 18,  159 => 17,  156 => 16,  146 => 15,  136 => 13,  131 => 11,  128 => 10,  125 => 9,  122 => 8,  112 => 7,  100 => 4,  97 => 3,  87 => 2,  77 => 15,  74 => 14,  72 => 7,  69 => 6,  66 => 2,  47 => 1,);
    }
    ...
    {% endblock %}
{% endblock %}
", "@Storefront/storefront/component/product/card/meta.html.twig", "/var/www/html/shopwaresix/vendor/shopware/storefront/Resources/views/storefront/component/product/card/meta.html.twig");
    }
}
