...
class __TwigTemplate_52bde73d5a9b3958da4b4754d0d7ba2726e6f49c9ef38d67204d329b64e302ef extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_layout_header_logo($context, array $blocks = [])
    {
        ...
        echo "                <div class=\"col-12 col-lg-auto header-logo-col\">
                    ";
        // line 10
        $this->loadTemplate("@StandardTheme/storefront/layout/header/logo.html.twig", "@Storefront/storefront/layout/header/header.html.twig", 10)->display($context);
        // line 11
        echo "                </div>
            ";
    ...
    {% endblock %}
{% endblock %}
", "@Storefront/storefront/layout/header/header.html.twig", "/var/www/html/shopwaresix/vendor/shopware/storefront/Resources/views/storefront/layout/header/header.html.twig");
    }
}
